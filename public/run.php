...
function baseDir(): string { return dirname(__DIR__); }
function clientsDir(): string { return baseDir() . '/clients'; }
function storageDir(): string { return baseDir() . '/storage'; }
function downloadsDir(): string { return baseDir() . '/downloads'; }
